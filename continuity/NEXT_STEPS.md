...
26. Validate local-vs-Zulu time mode toggle across AP/client/bluetooth/SDR table timestamps, GPS/status panels, SDR CSV timestamp fields, and SDR decoder text logs.
